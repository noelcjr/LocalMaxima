...
class read_charmm_FF():
    def __init__(self, verbose=False):
        self.toppath = pkg_resources.resource_filename('LocalMaxima', 'ThirdPartySoftware/charmm/params/' + 'top_all27_prot_na.rtf')
        self.parpath = pkg_resources.resource_filename('LocalMaxima', 'ThirdPartySoftware/charmm/params/' + 'par_all27_prot_na.prm')
        self.v = verbose
            ...
            for line in f:
                ...
                if len(s) >= 1:
                    if s[0] == "BONDS":
                        ...
                        cmap = False
                        nonbonded = True
                # THROWS a message when not parsing from a section that doesPAR = CP.read_charmm_FF()
